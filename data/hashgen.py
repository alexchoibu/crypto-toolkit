...
with open("0_9999_hashes.csv", "w") as output_file:

    output_file.write("Algorithm,Input,Output,Key\n")
    ...
    for i in range(10000):
        ...
        output_file.write(f"MD5,{md5_hex},{number_str},NaN\n")
        output_file.write(f"SHA-1,{sha1_hex},{number_str},NaN\n")
        output_file.write(f"SHA-224,{sha224_hex},{number_str},NaN\n")
        output_file.write(f"SHA-256,{sha256_hex},{number_str},NaN\n")
        output_file.write(f"SHA-384,{sha384_hex},{number_str},NaN\n")
        output_file.write(f"SHA-512,{sha512_hex},{number_str},NaN\n")
        output_file.write(f"SHA3-256,{sha3_256_hex},{number_str},NaN\n")
        output_file.write(f"BLAKE2b,{blake2b_hex},{number_str},NaN\n")

print("Hashes generated and written to 0_9999_hashes.csv")